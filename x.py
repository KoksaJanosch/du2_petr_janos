...
def nejblizsi(dic_kontejnery, dic_adresy):
    ...
    for (a_adresa, a_geo) in dic_adresy.items():
        ...
        for k_geo in dic_kontejnery.values():
            ...
            vzdalenost = vypocet_vzdalenosti(
                adresa_x, adresa_y, kontejner_x, kontejner_y)
...
print("Průměrná vzdálenost ke kontejneru je", prumerna_vzdalenost(nejkratsi_vzdalenosti, nejkratsi_vzdalenosti))
...
print("slovník vzdáleností:", dic_kontejnery)